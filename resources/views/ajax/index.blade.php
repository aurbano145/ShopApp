                            ...
                            <ul class="top-menu">
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="wishlist.html"><i class="icon-heart-o"></i>Wishlist <span>(0)</span></a></li>
            ...
            <main class="main">
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <div class="products">
                            <div class="row" id="clothesInfo"></div>
                            <br>
                            <nav aria-label="Page navigation">
    						    <ul class="pagination justify-content-center" id="clothesPages"></ul>
    						</nav>
                        </div>
                                        ...
                                        <div class="widget-body">
                                            <div class="filter-items filter-items-count">
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <!--input type="checkbox" class="custom-control-input" id="cat-1"-->
                                                        <a href="#">Cheaper - More expensive</a>
                                                    </div><!-- End .custom-checkbox -->
                                                </div><!-- End .filter-item -->
                                                ...
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <!--input type="checkbox" class="custom-control-input" id="cat-2"-->
                                                        <a href="#">More expensive - Cheaper</a>
                                                    </div><!-- End .custom-checkbox -->
                                                </div><!-- End .filter-item -->
